...
const Menu = () => {
  return (
    <nav className='mt-0.5 mb-1'>
        ...
        {({isActive}) => (
    <div className={classNames('transition-colors p-3 rounded-full inline-flex items-center gap-5  group-hover:bg-[#eff3f41a]',{
        "font-bold":isActive
    } )}>
    {!isActive && (
