...
<img src={account.avatar} className='w-10 h-10 rounded-full' alt="" />
      ...
      {currentAccount.id == account.id && (
        ...
        <button className='py-3 px-4 text-left hover:bg-[#eff3f41a] transition-colors w-full text-[#e7e9ea] text-[15px] leading-[20px]'>
        ...
        <button className='py-3 px-4 text-left hover:bg-[#eff3f41a] transition-colors w-full text-[#e7e9ea] text-[15px] leading-[20px]'>
          ...
          @emreylmz017 hesabından çıkış yap
          </div>
